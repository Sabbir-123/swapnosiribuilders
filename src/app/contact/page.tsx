    ...
    <div className="pt-24 bg-transparent">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <ScrollReveal variant="fade-right" duration={0.9} className="lg:col-span-5 w-full text-left space-y-8">
            <div>
              ...
              {/* Operational hours */}
              <div className="bg-[#140f2a]/80 p-6 rounded-2xl border border-white/10 text-xs text-white font-sans space-y-3 mt-8">
          ...
          <ScrollReveal variant="scale-up" duration={0.9} delay={0.15} className="lg:col-span-7 w-full">
            <InquiryForm />
          </ScrollReveal>
        </div>
      </section>
      ...
      <section className="h-[450px] relative w-full overflow-hidden border-t border-white/5 bg-[#140f2a]/25 backdrop-blur-[2px]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 text-center text-white">
          <ScrollReveal variant="scale-up" duration={0.9} className="w-full max-w-sm">
            <div className="border border-white/10 p-8 rounded-2xl bg-[#1e1740] shadow-2xl space-y-4">
