    ...
    <div className="relative overflow-x-hidden">
      ...
      <section className="py-32 bg-[#0e0b1f]/80 relative overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            {/* Visual Column */}
            <div className="lg:col-span-5 relative aspect-[4/5] rounded-3xl overflow-hidden border-2 border-white/10 group shadow-luxury-glow">
              <Image
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {[
              ...
              <div 
                key={idx}
                className="bg-white/[0.02] backdrop-blur-md p-8 rounded-2xl border border-white/8 hover:border-gold/30 hover:shadow-gold-glow hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
              >
      ...
      <section className="py-32 bg-[#140f2a]/70 relative overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 text-center relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-left">
            {SBL_SERVICES.map((serv) => (
              <div 
                key={serv.id}
                className="bg-white/[0.02] backdrop-blur-md p-8 rounded-2xl border border-white/8 hover:border-gold/30 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-4">
      ...
      <section className="py-32 bg-[#0a0818]/75 relative overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative aspect-[4/5] rounded-3xl overflow-hidden border border-white/10 shadow-luxury-glow order-1 lg:order-2 bg-[#0e0b1f]">
      ...
      <section className="py-32 bg-[#110d24]/75 relative overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            {/* CEO Image */}
            <div className="lg:col-span-4 relative aspect-square md:aspect-[4/5] lg:aspect-[4/5] rounded-3xl overflow-hidden shadow-luxury-glow group border-2 border-gold/25">
              <Image
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
            {SBL_NEWS.map((art) => (
              <div 
                key={art.slug}
                className="bg-white/[0.02] backdrop-blur-md rounded-3xl overflow-hidden border border-white/8 hover:border-gold/30 hover:shadow-gold-glow hover:-translate-y-0.5 transition-all duration-300 flex flex-col justify-between"
              >
                <div>
      ...
      <section className="py-32 bg-navy-gradient text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-6 w-full max-w-xl mx-auto shadow-luxury-glow rounded-2xl">
              <InquiryForm />
            </div>
          </div>
        </div>
